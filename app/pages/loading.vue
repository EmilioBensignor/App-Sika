<template>
    <main class="main flex flex-col justify-center items-center gap-6 px-5 md:px-8">
        ...
        <p class="md:text-4xl text-primary font-bold uppercase">
...
onMounted(() => {
    setTimeout(() => navigateTo(ROUTE_NAMES.RESULTADO), 3500)
})
</script>
