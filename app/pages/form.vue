<template>
    <main class="flex flex-col items-center px-6 py-8 gap-6 min-h-screen">
        <div class="flex flex-col items-center gap-1 text-center">
            ...
            <p class="text-sm text-gray-dark">Contanos un poco sobre vos</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="flex flex-col gap-4 w-full">
            ...
            <FormTextField id="correo" v-model="form.correo" placeholder="Correo electrónico"
                type="email" icon="material-symbols:mail-outline" :error="errors.correo" />
            ...
            <p class="text-xs text-gray-dark text-center mt-1">
            ...
            <p v-if="submitError" class="text-error text-xs text-center">{{ submitError }}</p>
        </form>
    </main>
</template>
